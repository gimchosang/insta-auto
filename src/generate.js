...
## 캡션 — 카드보다 훨씬 자세하게
카드는 글자 수가 빠듯해서 요점만 담깁니다. **캡션이 본문입니다.**

- 6~10줄. 문단 사이를 한 줄 띄워 읽기 편하게.
- 첫 줄은 무슨 이야기인지 한 문장으로.
- 그다음 문단들에서 카드에 못 담은 **구체적인 내용**을 풀어 쓰세요.
  기관명, 지역, 날짜, 수치, 조치 내용 — 기사에 있는 것을 아끼지 말고 담으세요.
- 마지막 줄은 독자에게 묻는 한 문장으로 끝내세요. (예: "여러분은 어떻게 보셨나요?")
- **반응이나 댓글을 지어내지 마세요.** "이런 반응이 있습니다" 하고 없는 말을 만들면 안 됩니다.
